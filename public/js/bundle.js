        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in succcesful');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleDQ0bGVsIiwiYSI6ImNrdHN0dWdndzFrMHEzMG1weWJlOThteDQifQ.OAlSoMfn_oJ6JBKvrZzKJg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), "Data has been updated"));
            }
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51Jdx9oHt8pGBkw3YnKFFd5HxRZdBTYif51OghoN586Smo5ZIe1H7VFvFU7pZKiNmm71JuEtKDzfaLxbp4pfcrPV300o7L7hZgS');
            _context.prev = 1;
            _context.next = 4;
...
console.log('hellow from parcel'); //DOM ELEMENTS
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log(form); //axios will detect form as an object
