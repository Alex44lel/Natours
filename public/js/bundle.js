    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8007/api/v1/users/updateMyPassword' : 'http://localhost:8007/api/v1/users/updateMe';
            _context.next = 4;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("http://localhost:8007/api/v1/bookings/checkout-session/".concat(tourId));
